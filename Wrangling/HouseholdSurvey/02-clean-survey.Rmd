...
hh_clean <- 
  hh_clean %>%
  mutate(
    hhh_educ_ug_c = if_else(relation == "Me/respondent is the HoH", educ, hh_educ),
    hhh_educ_mw_c = if_else(relation == "Me/respondent is the HoH", educ_mw, hh_educ),
    hhh_gender_c = if_else(relation == "Me/respondent is the HoH", sex, gender_hhh),
    hhh_age_c = if_else(relation == "Me/respondent is the HoH", age_resp, hhh_age),
    educ = case_when(
      # Uganda
