...
## Ttables excl outside HHs for waterfall charts
...
create_waterfall <- function(country_name, country_data) {
  ...
  df <- data.frame(
    ...
    amount = c(
      ...
      country_data$table12_ex_outside - country_data$table1_exout,
      country_data$table10_ex_outside - country_data$table12_exout,
