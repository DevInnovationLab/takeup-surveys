...
pm_survey <-
  ...
  left_join(wp_census %>%
              select(wp_id, intervention_type, sample_group, country),
            by = "wp_id")
...
ea_list_uganda <-
  ...
  left_join(wp_census %>%
            ...
            select(ea_id, intervention_type, country),
...
# waterfall charts
## TO DO share of households outside village among EA water points
```{r}
