...
users_with_ci_combined_grouped <- users_with_ci_combined %>%
  group_by(country, intervention) %>%
  summarise(
    pop_points = sum(pop_points),
...
users_with_ci_combined_grouped
```
...
table %>% select(country, intervention, per_wp_users, hh_size, n_wp, n_hh_count, n_wp_chl, n_hh, pop_points, popn_users, popn_users_lb, popn_users_ub, tcr, tcr_lb, tcr_ub, fcr, fcr_lb, fcr_ub)
