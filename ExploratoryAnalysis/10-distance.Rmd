...
## logit
As the Evidence Action water point becomes relatively farther compared to the primary water point (i.e., as the distance differential increases by 1 km), the probability of detecting chlorination in household water decreases by approximately 28 percentage points.
```{r}
...
model_logit <- glm(disc_tcr_detected ~ ea_minus_primary_km + hh_under5yn + wp_secweek + dsw + ilc, 
                   data = hh_filtered,
