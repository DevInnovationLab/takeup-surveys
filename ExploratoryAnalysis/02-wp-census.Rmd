...
LW: a table counting the number of observations, and counting how many of them satisfy the eligibility critera (communal, used for drinking, functional)
...
LW: Add a table showing: average number of water points per village, nubmer of villages with DSW, average number of DSW water points per village (only if any ILC is present), number of villages with ILC, average number of ILC water points per village (only if any ILC is present)
