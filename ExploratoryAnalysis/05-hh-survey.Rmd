...
spot check: variables of interest are meter_fill, meter_rinse, coninterpret etc; link to hh_survey / hh_census using hh_id
back checks: variables of interest are ; link to hh_survey / hh_census using household_id_pl
