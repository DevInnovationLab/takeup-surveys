...
Add a table showing:
- Number of water points visited
- Number of water points tested with color wheel
- Number of water points tested with colorimeter

## Color wheel and colorimeter readings

```{r}
wp_test %>%
  select(wp_id_c, matches("(.)cr$")) %>%
  pivot_longer(
    cols = -wp_id_c,
    names_pattern = "(.*)_(.*)",
