...
\subsubsection{Sample selection of water points (reviewed)}
...
\textit{However, we also find evidence indicating that promoters are less effective at identifying all of the users, leaving part of the households that rely on water points with DSW/ILC as their primary source of drinking water out of their lists.} Of the households in the Household Census whose primary water point was covered by the Promoter Survey, around 70\% are included in the promoter list in Malawi, while in Uganda this share is only 45\% (Table \ref{tab:adoption-hhs}). Therefore, there could be sample selection with regard to which households are included in the promoter lists.

Households surveyed as part of the promoter sample confirmed that they use the water points they were listed to, but around 85\% of those listed as using DSW water points confirmed these are their primary water sources, and only 78\% in ILC. 

\textcolor{red}{Among the households in the Census Sample that self-report using water points listed by the promoter, those included in the promoter list are only significantly different from those that are not in ILC water point (Table \ref{adoption-hhselection}). Households in the promoter list are more likely to have chlorine detected in DSW, but the difference is not statislcally signicant. However, given that most households in the Census Sample are also in the promtoer list, this difference is not statistically significant.

Note that the higher chlorine dtectin rate is also observed in households randomized into the survey, but tested in the first day. This indicates to sampling variation leading a part of the difference, since these households wre not exposed to priming and the difference between this group and that in column (3) of the figure is random.


\subsubsection{Priming}

As discussed in Section \ref{sec:adoption-priming}, the duration of activities in the village could lead to an overestimation, as it allows time for promoters and users to react to the presence of the field team and the attention brought to chlorination. Because surveying households from the Promoter Sample was the last activity carried out in each village, taking place after the Promoter Survey, the potential for bias is exacerbated in these estimates compared to the Census Sample.

The ideal test to determine if timing biases estimates would compare the same households surveyed as part of both the Census and the Promoter samples and determine whether chlorine detection rates among them were higher the second time they were tested. However, too few households in our data were tested twice. Instead, we compare households in the Census Sample that were interviewed during the first day of Household Survey activities to those surveyed later on. In Uganda, households surveyed \textit{after} the first day are 30\% ($\simeq$ 37\%/28.1\%) more likely to have TCR detected in their water samples (Table \ref{tab:adoption-day}). The difference between the days is not significant in Malawi.
...
Households in the promoter list were not more likely to have been affected by promoters interference than households who were not on the list. 
