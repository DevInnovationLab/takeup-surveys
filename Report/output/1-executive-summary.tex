...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{3 million (95\% CI = 2.6 - 3.2 million) people are using these water points with DSW} (50\% higher than our main estimate) and  \textbf{28.5\% (95\% CI = 23\%- 34.1\%)} of the households using water points with DSW have TCR detected in their water, which is very similar to our main estimates. \textcolor{red}{We believe the difference in reach estimates to be due to...}
        \item \textbf{180,000 (95\% CI = 152,000 - 208,000) are using water points with ILC} (140\% more than in our main estimates. 
        and \textbf{15.4\% (95\% CI = 6.6\% - 24.2\%)} of those using ILC, which is aproximately half of our main estimates. \textcolor{red}{Our results point to this being due to promoters including more people in theri list of users than actually use these water pointson average, 3.4 times the number of self-reports}
    \end{itemize}
\end{itemize}