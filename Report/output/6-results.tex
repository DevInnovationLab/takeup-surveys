...
We estimate that approximately 3.9 million people in Uganda use water points with DSW as their primary source of drinking water. In Malawi, we estimate this number to be about 2 million people, and that another 75,000 people use water points with ILC as their primary source of drinking water.
...
\textit{TCR detection rates among households using water points with ILC (29\%) are similar to those among households using DSW}. This can be rationalized by taking into account that while ILC does not require the additional user effort of water treatment or the discomfort of handling dilute chlorine, it may be harder to dose and maintain. 

The latter claim is supported by findings from our water point census. More than 95\% of the water points with DSW were functional at the time of the survey, and we detect FCR concentrations above 0.2 mg/L in 96\% of the water points with filled and functional dispenser (or 67\% of all the functional water points with DSW). In ILC systems, on the other hand, both functionality and FCR detection rates are lower. 72\% of the water points and we find that For ILC systems, we find that FCR concentrations meet the same threshold in 64\% of the closest water collection points to the ILC device, and in only 26.5\% of the other water collection points. Add

Table \ref{tab:dsw-func} shows functionality rates for DSW dispensers in Malawi and Uganda, and Table \ref{tab:dsw-func} presents chlorine detection rates at the water points after treating the water with dilute chlorine solution from the dispenser. Since functionality rates and detection at the water point do not point to any major issues with dispensers, we attribute the existing adoption rates primarily to household preferences and the behavioral component of dispenser usage. Tables \ref{tab:ilc-func} and \ref{tab:ilc-cl} show functionality and chlorine detection rates at ILC water points, respectively. It is harder to calculate access to chlorine, \textcolor{red}{but say a back-of-the-envelope points to \%.}
