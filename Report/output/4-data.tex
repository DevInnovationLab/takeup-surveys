...
In Malawi, households using water points with ILC are the most likely to use more than one water point (which is consistent with the lower functionality rate of these water points), although their are not significantly more likely than households using water points not served by DSW or ILC. Households using water points with DSW are the least likely to have collected drinking water from more than one water collection point in the month before data collection.
...
\textcolor{red}{\textbf{Self-reported water treatment.} In Uganda, households using water points with DSW are just are likely to report treating the drinking water as households using other water points, but they are twice as likely to using chlorine for treatment ($\sim$30\% vs $\sim$15\%). In Malawi, the share of households that report treating the drinking water with chlorine is similar among the two groups ($\sim$30\%), but households using water points with DSW are three times more likely to use the dilute chlorine solution from the dispenser ($\sim$30\%) as those using other water points ($\sim$10\%). Households using water points with ILC are less likely to report treating the water than any other group in our sample.}