...
\textbf{In Malawi, the final numbers of villages per group deviate slightly from the original targets due to the reasons discussed in Section \ref{sec:data-malawi}.} This deviation has three main implications. First, the number of villages served by ILC is smaller than originally planned, which adds noise to our estimates and increases the risk of small sample bias. Second, the share of villages served by DSW where ILC is available or was available at some point in time is larger than originally designed. Third, we observe a relatively small number of clusters, meaning are estimates may suffer from small sample bias.
...
\textbf{lower quality data in malawi} 
...
\textcolor{red}{households using water points within the village}
