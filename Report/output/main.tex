...
\title{Independent chlorine coverage surveys\\Preliminary results including Uganda ILC villages}
...
\textcolor{red}{Results for Uganda ILC villages are preliminary and may change after further exploration and QA.}
\begin{itemize}
    \item The estimates presented here perform exactly the same analysis as for ILC villages in Malawi
    \item This means that no adjustments have been made based on water point functionality and distance from the tank with the ILC device
    \item We may incorporate such adjustments after further exploration of the water point-level data and of the enumerator comments about each water point
\end{itemize}
