...
This Appendix details the steps used to estimate the relative importance of various factors in explaining the difference in estimates between the census (Table \ref{tab:headlines-vil} and the monitoring approach (Table \ref{tab:headlines-am}).
