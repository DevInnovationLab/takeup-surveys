\begin{table}[H]
\centering
\caption{\label{tab:adoption-hhs}Chlorine Residual detection rates among households in the census sample using water points covered by the Promoter Survey}
\centering
...
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Households using water points with DSW/ILC} & \multicolumn{2}{c}{Households included in the promoter list} \\
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5}
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Households using water points with DSW/ILC} & \multicolumn{2}{c}{Households included in the promoter list} \\
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5}
 & N & Included in the promoter list & N & Water point with DSW/ILC is
