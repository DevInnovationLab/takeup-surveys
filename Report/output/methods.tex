...
We use the R package \textit{survey} to calculate the country-level estimates and their respective confidence interval \citep{survey}.  The point estimates are equivalent to the procedure described below, but it also calculates the standard errors clustered by village and corrected for the sampling weights:
