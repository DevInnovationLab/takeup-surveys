...
hh_size_comparison <- bind_rows(
  hh_size_promoter_avg %>% mutate(promoter_surveyed = TRUE),
  hh_size_nonpromoter_avg %>% mutate(promoter_surveyed = FALSE)
)
...
#####by monitoring survey vs household survey
```{r}
