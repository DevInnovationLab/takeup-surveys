...
people_per_group %>%
  ...
  write_csv(
    here("output/results/users-vil.csv")
  )
```
...
cl_village_noweights_country %>%
  write_csv(
    here("output/results/chlorine-vil.csv")
  )
```
...
users_vil    <- read_csv(here("output/results/users-vil.csv"))
chlorine_vil <- read_csv(here("output/results/chlorine-vil.csv"))
...
writeLines(
  rows,
  here("output/tables/headlines-vil.tex")
)
