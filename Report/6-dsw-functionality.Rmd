...
kable(
  ...
  footnote(
    general = "The sample includes all water points in the water point census, some of which are located outside of village boundaries. The denominator for columns (4) to (8) is column (3). A dispenser is considered to be filled if chlorine was released after turning the valve. This is different from the definition used by Evidence Action in their Adoption Monitoring, when surveyors open the dispenser casing to check if there is chlorine in the tank. Therefore, the numbers in column (8) correspond to functional and filled dispensers in Evidence Action's data.",
    threeparttable = TRUE
  ) %>%
  writeLines(
