...
evac <-
  ...
  mutate(
    sample_group = 
      if_else(
        country == "Uganda", 
        pre_expansion %>% as.character, 
        sample_group %>% as.character
      ) %>%
      factor(levels = c("Footprint", "Expansion", "ILC"), ordered = TRUE)
  ) %>%
  group_by(
...
wp_sample_sizes <-
  tribble(
    ...
    "Malawi", "Expansion", "DSW", 12949,
    "Malawi", "Footprint", "DSW", 2187,
    "Malawi", "ILC", "DSW", 1062,
    "Malawi", "ILC", "ILC", 2024,
...
sample_sizes <-
  tribble(
    ~ country, ~ sample_group, ~ wp_intervention, ~ pop_vil, ~ sampled_villages,
    "Malawi", "Expansion", "DSW", 1161, 28,
    "Malawi", "Footprint", "DSW", 4809, 28,
    "Malawi", "ILC",       "DSW", 275,  24,
    "Malawi", "ILC",       "ILC", 637,  46,
    "Uganda", "Expansion", "DSW", 3332, 30,
    "Uganda", "Footprint", "DSW", 4084, 30
  )
```
