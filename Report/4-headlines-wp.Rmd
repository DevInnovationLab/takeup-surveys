...
col_names <- 
  linebreak(
    c("Intervention", "Sample group", "\\#WP", "\\#HH", "\\#WP", "People using\nDSW/ILC\n(95\\% CI)", "\\#WP", "\\#HH", "TCR\n(95\\% CI)", "FCR\n(95\\% CI)"),
    align = "c"
  )
